...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=200&color=0369A1&text=Rishitha%20Gogineni&fontColor=ffffff&fontSize=48&fontAlignY=38&desc=Building%20AI%20Systems%20%C2%B7%20Former%20Data%20Engineer&descAlignY=58&descSize=18&animation=fadeIn" alt="header" />
...
## <img src="https://media.giphy.com/media/WFZvB7VIXBgiz3oDXE/giphy.gif" width="28"> AI / ML Expertise
...
A full-stack, evidence-grounded research assistant that retrieves and synthesizes answers across 250+ AI papers, with a confidence gate that refuses to answer when the corpus lacks support.
...
An end-to-end analytics pipeline ingesting historical and near-real-time Formula 1 telemetry, transformed through a modern data stack and surfaced in an interactive dashboard.
...
Orchestrated dual ingestion pipelines in Airflow — weekly historical loads and daily real-time updates — with staging, intermediate, and fact models in dbt loading into Snowflake for dashboard consumption.
...
### Data Engineer · Capgemini Technology Services
`Apr 2024 – May 2025` · Hyderabad, India
...
![Azure Data Engineer](https://img.shields.io/badge/Microsoft%20Certified-Azure%20Data%20Engineer%20Associate-0089D6?style=for-the-badge&logo=microsoftazure&logoColor=white&labelColor=0D1117)
...
<img width="100%" src="https://raw.githubusercontent.com/rishitha-gogineni/rishitha-gogineni/output/github-contribution-grid-snake-dark.svg" alt="snake animation" />
...
## <img src="https://media.giphy.com/media/VgCDAzcKvsR6OM0uWg/giphy.gif" width="26"> Current Focus

```yaml
learning:
  - Advanced agent architectures & tool-use
  - Model fine-tuning and evaluation at scale
building:
  - Evaluation-first RAG systems with measurable quality
  - Faithfulness and confidence assessment for LLM outputs
exploring:
  - Distributed systems for ML serving
  - Retrieval optimization and reranking
open_to:
  - Summer 2027 internships: Applied AI · AI Engineer · SWE (AI-focused)
```
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=120&section=footer&color=0369A1" alt="footer" />
